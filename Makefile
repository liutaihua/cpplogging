...
# Project:  test.pro
# Template: app
# Command: /Users/liutaihua/Qt/5.4/clang_64/bin/qmake -o Makefile test.pro
#############################################################################
...
DEFINES       = -DSRCDIR=\"/terminus/crown/\" -DTIXML_USE_STL -D__GXX_EXPERIMENTAL_CXX0X__ -DDEBUG -DBOOST_SPIRIT_THREADSAFE -DQT_NO_KEYWORDS
...
#CXXFLAGS      = -std=c++0x -pipe -O2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -mmacosx-version-min=10.7 -Wall -W -fPIC $(DEFINES)
#INCPATH       = -I. -I../Qt/5.4/clang_64/mkspecs/macx-clang -I/usr/local/include
...
CXXFLAGS      = -pipe -g -O0 -std=c++0x -mmacosx-version-min=10.7 -stdlib=libc++ -W -Wno-unused-parameter -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -mmacosx-version-min=10.7 -fPIC $(DEFINES)
INCPATH       = -I../crown -I. -I../crown/sdu -I../crown/newlist -I../crown/Transfer -I../crown/GameHolder -I../crown/GameHolder/Skills -I../crown/GameHolder/Buffs -I../crown/GameHolder/Mask -I../crown/GameLogic -I../crown/GameLogic/Skills -I../crown/GameLogic/Buffs -IGameLogic/Mask -I../crown/GameHolder/Observers -I../crown/Collision -I../crown/Configuration -I../crown/deps/tinyxml -I../crown/deps/fd -I../crown/deps -I../crown/deps/curlpp-0.7.3/include -I/usr/local/include -I/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7 -I/usr/include -I/usr/local/include -I/Users/liutaihua/Qt/5.4/clang_64/mkspecs/macx-clang -I/usr/local/include
QMAKE         = /Users/liutaihua/Qt/5.4/clang_64/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /Users/liutaihua/cpplogging/.tmp/test1.0.0
...
Makefile: test.pro ../Qt/5.4/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.4/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.4/clang_64/mkspecs/qdevice.pri \
		../Qt/5.4/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.4/clang_64/mkspecs/common/shell-unix.conf \
		../Qt/5.4/clang_64/mkspecs/common/unix.conf \
...
tmp/main.o: main.cpp Logging.h \
		singleton.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/main.o main.cpp

tmp/Logging.o: Logging.cpp Logging.h \
		singleton.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/Logging.o Logging.cpp
